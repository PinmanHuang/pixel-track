...
void drawRectangle(Image8U* img, Rectangle r, double rotation, Colour c, int Thickness/*=1*/)
{
  ...
  r.rotate(rotation, x1, y1, x2, y2, x3, y3, x4, y4);

  drawLine(img, x1, y1, x2, y2, c, Thickness);
  drawLine(img, x2, y2, x3, y3, c, Thickness);
  drawLine(img, x3, y3, x4, y4, c, Thickness);
  drawLine(img, x4, y4, x1, y1, c, Thickness);
}
